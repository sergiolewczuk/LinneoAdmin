...
public class SeleccionarAlumnosEnCuotas extends javax.swing.JDialog {
    ...
    class KeyDispatcher implements KeyEventDispatcher {
        ...
        public boolean dispatchKeyEvent(KeyEvent e) {
            ...
            if (e.getID() == KeyEvent.KEY_PRESSED) {
                ...
                if (SeleccionarAlumnosEnCuotas.this.isActive()) {
    ...
    void CargarInscriptos() {
        cuotas.CargarAlumnosCuotas();
        
        Clases.Class_editar_tabla.main(jTable1, cuotas.datos);
    }
    
    void CargarDeudores() {
        cuotas.CargarDeudoresCuotas();
        
        Clases.Class_editar_tabla.main(jTable1, cuotas.datos);
    }
    
    public SeleccionarAlumnosEnCuotas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton3.setText("F1 - Ver Deudores");
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        if(jButton3.getText().equals("F1 - Ver Deudores")){
            // CARGAR INSCRIPTOS
            if (jTextField1.getText().isEmpty()) {
                CargarInscriptos();
            } else {
                cuotas.FiltrarAlumnoCuotas(jTextField1.getText());
            ...
            if (jTextField1.getText().isEmpty()) {
                ...
                cuotas.FiltrarDeudoresCuotas(jTextField1.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTable1.getSelectedRow() != -1) {
            ...
            datos[2] = jButton3.getText();
            
            setVisible(false);
            dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Debe Seleccionar un Alumno", "LinneoAdmin", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        if(jButton3.getText().equals("F1 - Ver Deudores")) {
            jButton3.setText("F1 - Ver Inscriptos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarAlumnosEnCuotas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SeleccionarAlumnosEnCuotas dialog = new SeleccionarAlumnosEnCuotas(new javax.swing.JFrame(), true);
