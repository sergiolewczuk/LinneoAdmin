...
public class SeleccionarResponsableEnCuotas extends javax.swing.JDialog {
    ...
    class KeyDispatcher implements KeyEventDispatcher {
        ...
        public boolean dispatchKeyEvent(KeyEvent e) {
            ...
            if (e.getID() == KeyEvent.KEY_PRESSED) {
                ...
                if (SeleccionarResponsableEnCuotas.this.isActive()) {
    ...
    void Cargar() {
        cuotas.CargarResponsableCuotas();
        
        Clases.Class_editar_tabla.main(jTable1, cuotas.datos);
    }
    
    
    public SeleccionarResponsableEnCuotas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DNI", "APELLIDO Y NOMBRE", "ESPACIOS"
            }
        ) {
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        if (jTextField1.getText().isEmpty()) {
            ...
            cuotas.FiltrarResponsablesCuotas(jTextField1.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarResponsableEnCuotas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SeleccionarResponsableEnCuotas dialog = new SeleccionarResponsableEnCuotas(new javax.swing.JFrame(), true);
