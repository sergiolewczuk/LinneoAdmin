 ...
 * @author jason
 */
public class SubDiario extends javax.swing.JInternalFrame {
    ...
    void DiarioFecha () {
        if (!"".equals(jTextField1.getText()) && !"".equals(jTextField2.getText()) && !"".equals(jTextField3.getText()) && !"".equals(jTextField4.getText()) && !"".equals(jTextField5.getText()) && !"".equals(jTextField6.getText())) {
            if ("NORMAL".equals(jComboBox1.getSelectedItem().toString())) {
                ...
                BigDecimal[] dou = diario.CargarSUBDiario(desde, hasta);
                ...
                String desde = jTextField3.getText() + "-" + jTextField2.getText() + "-" + jTextField1.getText();
                String hasta = jTextField6.getText() + "-" + jTextField5.getText() + "-" + jTextField4.getText();
                BigDecimal[] dou = diario.CargarSUBDiarioResumido(desde, hasta);
            ...
            if ("NORMAL".equals(jComboBox1.getSelectedItem().toString())) {
                Clases.DiarioSubdiario diario = new Clases.DiarioSubdiario();
                BigDecimal[] dou = diario.CargarSUBDiario();
                ...
                Clases.DiarioSubdiario diario = new Clases.DiarioSubdiario();
                BigDecimal[] dou = diario.CargarSUBDiarioResumido();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class
            };
        ...
        jButton1.setText("DIARIO DE LA FECHA SELECCIONADA [F1]");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (seleccion == 0) {
            ...
            if (printService.length > 0) {//si existen impresoras
                ...
                if (impresora != null) //Si se selecciono una impresora
                {
                    try {
                        ...
                        params.put("titulo", "LIBRO SUB-DIARIO");
            ...
            FileDialog fd = new FileDialog(new JDialog(), "Guardar Libro SubDiario", 1);
            fd.setFile("Libro SubDiario");
            fd.setVisible(true);
